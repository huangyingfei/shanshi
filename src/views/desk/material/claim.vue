<template>
  <div class="unsaved">
    ...
    <div class="update">
      ...
      <el-button size="medium" icon="el-icon-search" type="success" style=" margin-left: 20px; ">搜索</el-button>
    </div>
    <!-- 添加食材 -->
    <div class="cadddr">
      <el-button size="medium" type="success" @click="address">添加相克食材</el-button>
    ...
    <div class="address">
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="address" label="食材一" width="160" align="center"></el-table-column>
        <el-table-column prop="stats" label="食材二" width="160" align="center"></el-table-column>
        <el-table-column prop="malloc" label="不宜同食原因" width="180" align="center"></el-table-column>
        <el-table-column prop="decls" label="是否有效" width="120" align="center"></el-table-column>
    ...
    <!-- 添加相克食材 -->
    <el-dialog title="添加相克食材" append-to-body :visible.sync="dateTime" :close-on-click-modal="false">
      <el-form
        :model="ruleForm"
        :rules="rules"
        ref="ruleForm"
