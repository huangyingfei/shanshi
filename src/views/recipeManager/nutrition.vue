      ...
      <div>
        <section class="print-page" ref="printSec" id="printMe">
          ...
          <el-row>
            <el-col :span="24">
              <span
                >二.营养素摄入量：(要求日托儿童没人每日各种营养素摄入量达到DRIs的80%以上，全托儿童能量和蛋白质达到DRIs的90%以上，其他营养素达到80%以上)</span
              >
            </el-col>
          </el-row>
          <!-- 营养素摄入量表格开始 -->
          <el-row>
            <el-col :span="24">
              <el-table
                size="small"
                :data="foodNutritionExcleDtoList"
                border
                :header-cell-style="headerRowStyle"
              >
          ...
          <el-row :gutter="40">
            ...
            <el-col :span="12">
              <el-table size="small" :data="powerSourceExcelDtoList">
                <el-table-column label="" prop="target"> </el-table-column>
          ...
          <el-row>
            <el-col :span="24">
              <el-table
                size="small"
                border="ture"
                :header-cell-style="cateringEnergyHead"
                :data="calSourceExcelDTOList"
                :span-method="calArraySpanMethod"
              >
                ...
                <el-table-column label="星期一(Mon)" align="center">
                  <el-table-column prop="mon" label="能量" min-width="50">
                  </el-table-column>
                  <el-table-column prop="monProp" label="占比%" min-width="60">
                  </el-table-column>
                </el-table-column>
                <el-table-column label="星期二(Tue)" align="center">
                  <el-table-column prop="tue" label="能量" min-width="50">
                  </el-table-column>
                  <el-table-column prop="tueProp" label="占比%" min-width="60">
                  </el-table-column>
                </el-table-column>
                <el-table-column label="星期三(Wed)" align="center">
                  <el-table-column prop="wed" label="能量" min-width="50">
                  </el-table-column>
                  <el-table-column prop="wedProp" label="占比%" min-width="60">
                  </el-table-column>
                </el-table-column>
                <el-table-column label="星期四(Thu)" align="center">
                  <el-table-column prop="thu" label="能量" min-width="50">
                  </el-table-column>
                  <el-table-column prop="thuProp" label="占比%" min-width="60">
                  </el-table-column>
                </el-table-column>
                <el-table-column label="星期五(Fri)" align="center">
                  <el-table-column prop="fri" label="能量" min-width="50">
                  </el-table-column>
                  <el-table-column prop="friProp" label="占比%" min-width="60">
                  </el-table-column>
                </el-table-column>
                <el-table-column
                  label="星期六(Sat)"
                  ...
                  v-if="satShow"
                >
                  <el-table-column prop="sat" label="能量" min-width="50">
                  </el-table-column>
                  <el-table-column prop="satProp" label="占比%" min-width="60">
                  </el-table-column>
                </el-table-column>
                <el-table-column
                  label="星期日(Sun)"
                  ...
                  v-if="sunShow"
                >
                  <el-table-column prop="sun" label="能量" min-width="50">
                  </el-table-column>
                  <el-table-column prop="sunProp" label="占比%" min-width="60">
                  </el-table-column>
                </el-table-column>
              </el-table>
            </el-col>
...
export default {
  ...
  methods: {
    ...
    calArraySpanMethod({ row, column, rowIndex, columnIndex }) {
      if (columnIndex == 1) {
        var a = [0, 2];
    ...
    getNutritionDataList(data) {
      ...
      axios({
        ...
        // console.log('res')
        // console.log(res)
        this.foodAvgPeopleExcelDto = new Array(
          res.data.data.foodAvgPeopleExcelDto
        ); //平均每人进食量表格
        this.foodNutritionExcleDtoList =
          res.data.data.foodNutritionExcleDtoList; //营养素摄入量
        this.powerSourceExcelDtoList = res.data.data.powerSourceExcelDtoList; //能量来源分布
        this.proteinrSourceExcelDtoList =
          res.data.data.proteinrSourceExcelDtoList; //蛋白质来源分布
