            ...
            <el-col :span="24">
              <el-form :gutter="10" :inline="true" :model="WeekInfo">
                ...
                <el-form-item label="公开">
                  <el-switch v-model="WeekInfo.isPub"> </el-switch>
                </el-form-item>
                <el-form-item label="推荐">
                  <el-switch v-model="WeekInfo.isRecommend"> </el-switch>
                </el-form-item>
                <el-form-item label="收藏">
                  <el-switch v-model="WeekInfo.isUse"> </el-switch>
                </el-form-item>
              </el-form>
            </el-col>
          </el-row>
            ...
            <el-form-item>
              ...
              <el-popover placement="right" width="300" trigger="click">
                ...
                <div v-if="foodMutuals.length > 0">
                  <div v-for="(item, index) in foodMutuals" :key="item.msg">
          ...
          <el-card :class="[topShow ? 'box-car' : 'box-car1']" shadow="never">
            ...
            <div v-if="!showFoodList">
              ...
              >
                <el-link
                  :underline="false"
                  :class="{ recipeColor: recipeSelect == '1' }"
                  @click="recipeNameShareSearchPub('1', undefined, undefined)"
                  >全部
                </el-link>
                |
                <el-link
                  :underline="false"
                  :class="{ recipeColor: recipeSelect == '2' }"
                  @click="recipeNameShareSearchPub('2', 0, undefined)"
                  >公开
                </el-link>
                |
                <el-link
                  :underline="false"
                  :class="{ recipeColor: recipeSelect == '3' }"
                  @click="recipeNameShareSearchPub('3', 1, undefined)"
                  >隐藏
                </el-link>
                |
                <el-link
            ...
            <div v-if="showFoodList">
              ...
              >
                <el-link
                  :underline="false"
                  :class="{ dishColor: dishSelect == '1' }"
                  @click="dishShareSearchPub('1', 1)"
                  >全部
                </el-link>
                |
                <el-link
                  :underline="false"
                  :class="{ dishColor: dishSelect == '2' }"
                  @click="dishShareSearchPub('2', 1, 0)"
                  >公开
                </el-link>
                |
                <el-link
                  :underline="false"
                  :class="{ dishColor: dishSelect == '3' }"
                  @click="dishShareSearchPub('3', 1, 1)"
                  >隐藏
                </el-link>
              </div>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      WeekInfo: {
        ...
        flag: false, //第一次加载的时候  不计算分数   true
      },
      activeName: "first",
      activeName2: "thread",
      // 表格头部
  ...
  methods: {
    ...
    getNutritionData() {
      ...
      foods.startAge = this.WeekInfo.startAge;
    ...
    initData() {
      ...
      if (that.$route.query.userid) {
        ...
        that.WeekInfo.foodCatalog = ["早餐", "早点", "午餐"];
      }
      ...
      this.datas.forEach((data) => {
        ...
        data.weeks.forEach((week) => {
          ...
          if (children.length > 0) {
            ...
            row.push({
              peopleId: this.WeekInfo.startAge,
              recipeDay: this.WeekInfo.weekType,
              recipeCycles: recipeCycles,
            });
          }
    ...
    AppendFoodType() {
      ...
      setTimeout(function () {
        that.$refs.child.refreshData();
        that.$refs.child.resizeExpendHeight();
        that.$refs.child.getFoodScore(true);
      }, 200);
    },
