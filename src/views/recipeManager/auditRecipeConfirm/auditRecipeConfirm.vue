<template>
  <basic-container :block="true">
    <div class="meals">
      ...
      <el-row
        :gutter="20"
        style="padding: 0px; margin-top: 0px; height: 52vh; overflow: hidden"
      >
        <el-col span="4">
          <el-card class="box-car" shadow="never">
            ...
            <el-tabs v-show="!showFoodList" v-model="activeName">
              <!--//分享食谱-->
            ...
            <!--菜品-->
            <el-tabs v-show="showFoodList" v-model="activeName2">
      ...
      <div class="fixed" v-if="auditButtonShow">
        <el-row type="flex" justify="center" v-if="true">
          <el-col :span="4">
            <el-button @click="goToUrl">取 消 </el-button>
          </el-col>
          <el-col :span="4">
            <el-button type="primary" @click="openAuditRecipeBox"
              >拒 绝
            </el-button>
          </el-col>
          <el-col :span="4">
            <el-popover placement="top" width="160" v-model="visible">
              ...
              <div style="text-align: right; margin: 0">
                ...
                <el-button
                  type="primary"
                  size="mini"
                  @click="auditRecipeConfirmAgree({ status: 1 })"
                  >确定</el-button
                >
              </div>
...
import {
  ...
  detail,
  auditRecipe,
} from "@/api/recipeManager/auditRecipe.js";
