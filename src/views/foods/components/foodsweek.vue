  ...
  <div style="padding: 0px" >
    ...
    <el-table class="table-week" style="width: 100%" :data="datas" border fit>
      ...
      >
        ...
        <template slot-scope="scope">
          <div  class="drapIn"  @drop="drop($event, scope.row.id,'week2')" @dragleave="ondragleave($event)"  @dragenter="ondragenter($event)"   @dragover="ondragover($event)">
            <!-- table start -->
            <el-table
              class="table-foods"
              style="width: 100%"
      ...
      >
        ...
        <template slot-scope="scope">
          <div  class="drapIn"  @drop="drop($event, scope.row.id,'week3')" @dragleave="ondragleave($event)"  @dragenter="ondragenter($event)"   @dragover="ondragover($event)">
            <!-- table start -->
            <el-table
              class="table-foods"
              style="width: 100%"
      ...
      >
        ...
        <template slot-scope="scope">
          <div  class="drapIn"  @drop="drop($event, scope.row.id,'week4')" @dragleave="ondragleave($event)"  @dragenter="ondragenter($event)"   @dragover="ondragover($event)">
            <!-- table start -->
            <el-table
              class="table-foods"
              style="width: 100%"
      ...
      >
        ...
        <template slot-scope="scope">
          <div  class="drapIn"  @drop="drop($event, scope.row.id,'week5')" @dragleave="ondragleave($event)"  @dragenter="ondragenter($event)"   @dragover="ondragover($event)">
            <!-- table start -->
            <el-table
              class="table-foods"
              style="width: 100%"
      ...
      >
        ...
        <template slot-scope="scope">
          <div  class="drapIn"  @drop="drop($event, scope.row.id,'week6')" @dragleave="ondragleave($event)"  @dragenter="ondragenter($event)"   @dragover="ondragover($event)">
            <!-- table start -->
            <el-table
              class="table-foods"
              style="width: 100%"
      ...
      >
        ...
        <template slot-scope="scope">
          <div  class="drapIn"  @drop="drop($event, scope.row.id,'week7')" @dragleave="ondragleave($event)"  @dragenter="ondragenter($event)"   @dragover="ondragover($event)">
            <!-- table start -->
            <el-table
              class="table-foods"
              style="width: 100%"
