          ...
          <el-form :gutter="10" :inline="true" :model="formInline">
            ...
            <el-form-item label="选择人群">
              ...
              <el-select v-model="WeekInfo.crowd" placeholder="选择人群" class="crow-item" @change="selectPeople">
                <el-option v-for="(item ,index) in crowdData" :label="item.peopleName" :value="item.id"
          ...
          <el-form :gutter="10" :inline="true" :model="WeekInfo">
            ...
            <el-form-item>
              ...
              <el-popover
                ...
                <div v-if="foodMutuals.length>0" v-for="(item,index) in foodMutuals"><p>{{index+1}}、{{item.msg}}</p>
                </div>
              ...
              <el-popover
                ...
                width="300"
                trigger="click">
                <nutrient-with-color :nutrition="nutrition" :WeekTtitle="WeekInfo.WeekTtitle"
                                     :titleFlag="true"></nutrient-with-color>
      ...
      <el-row :gutter="20" style="padding: 0px; margin-top: 0px" @mouseover="HidenFoodTips($event)"
        ...
        <el-col :span="5">
          <el-card class="box-car" shadow="never">
            ...
            >
              <!--//分享食谱-->
              <el-tab-pane label="分享食谱" name="first" @mouseout="HidenFoodTips($event)">
                ...
                <div style="font-size: 10px;margin:0 10px;display: flex;justify-content:space-around">
                  <el-link :underline="false" :class="{'recipeColor':recipeSelectPub=='1'}"
                           @click="recipeNameShareSearchPub('1')">全部
                  </el-link>
                  |
                  <el-link :underline="false" :class="{'recipeColor':recipeSelectPub=='2'}"
                           @click="recipeNameShareSearchPub('2',1)">收藏
                  </el-link>
                </div>
                ...
                <ul class="foodWeekListHis" @mouseout="HidenFoodTips($event)" ref="boxScroll1">
              ...
              <!--//个人食谱-->
              <el-tab-pane label="个人食谱" name="second" @mouseout="HidenFoodTips($event)">
                <div style="margin-top: -5px; padding: 5px">
                  <el-input
                    size="small"
                    placeholder="请输入内容"
