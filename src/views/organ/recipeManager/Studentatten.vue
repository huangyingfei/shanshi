...
export default {
  ...
  methods: {
       //定义导出Excel表格事件
        ...
        .then(res => {
          console.log(res);
          let bold= new Blob([res.data], {type: 'application/vnd.openxmlformats- officedocument.spreadsheetml.sheet;charset=utf-8'})
          console.log(bold);
          
          window.location.href = window.URL.createObjectURL(bold);
        });
            // /* 从表生成工作簿对象 */
