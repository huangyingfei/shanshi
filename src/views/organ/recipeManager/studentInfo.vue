<template>
  ...
  <el-form class="r-stu" inline  :rules="rules" ref="student"   :model="student">
    <el-row>
      ...
      <el-col :span="8">
        <el-form-item label="档案号">
          <el-input v-model="student.fileNumber"   placeholder="请输入档案号"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
    ...
    <el-row>
      ...
      <el-col :span="8">
        <el-form-item label="年龄">
          <el-input-number
            :disabled="true"
            v-model="student.age" controls-position="right" ></el-input-number>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
      ...
      <el-col :span="8">
        <el-form-item label="学段">
          <el-input v-model="student.classSection"
                    :disabled="true"
                    placeholder="请输入学段"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
      ...
      <el-col :span="8">
        <el-form-item label="现住址">
          <el-input v-model="student.address"   placeholder="请输入现住址"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
    ...
    <el-row>
      <el-col :span="8">
        <el-form-item label="户口地址">
          <el-input v-model="student.accountAddress"  placeholder="请输入户口地址"></el-input>
        </el-form-item>
      </el-col>
      ...
      <el-col :span="8">
        <el-form-item label="疾病史">
          <el-input v-model="student.diseaseHistory"  placeholder="请输入疾病史"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
      ...
      <el-col :span="8">
        <el-form-item label="家庭电话">
          <el-input v-model="student.mobile"   placeholder="请输入家庭电话"></el-input>
        </el-form-item>

      </el-col>
      <el-col :span="8">
        <el-form-item label="联系电话">
          <el-input v-model="student.tel"   placeholder="请输入家庭电话"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
      ...
      <el-col :span="12">
        ...
        <el-radio-group v-model="student.realtive">
          <el-radio   v-for="item in realtive" :label="item.value">{{item.label}}</el-radio>
        </el-radio-group>
        </el-form-item>
      </el-col>
    ...
    <el-row v-if="leaveFlag">
      ...
      <el-col :span="8">
        <el-form-item label="离校前所在班级">
          <el-input v-model="student.leaveClassName"   placeholder=""></el-input>
          <!--<el-date-picker-->
    ...
    <el-row>
      <el-col :span="8">
        <el-form-item label="姓名">
          <el-input v-model="student.fatherName"   placeholder="请输入姓名"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label="手机号">
          <el-input v-model="student.fatherTel"   placeholder="请输入手机号"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label="民族">
    ...
    <el-row>
      ...
      <el-col :span="8">
        <el-form-item label="工作单位">
          <el-input v-model="student.fatherWorkunit"   placeholder="请输入工作单位"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
    ...
    <el-row>
      <el-col :span="8">
        <el-form-item label="姓名">
          <el-input v-model="student.momName"   placeholder="请输入姓名"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label="手机号">
          <el-input v-model="student.momTel"   placeholder="请输入手机号"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label="民族">
    ...
    <el-row>
      ...
      <el-col :span="8">
        <el-form-item label="工作单位">
          <el-input v-model="student.momWorkunit"   placeholder="请输入工作单位"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
    ...
    <el-row>
      <el-col :span="8">
        <el-form-item label="姓名">
          <el-input v-model="student.oneName"   placeholder="请输入姓名"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
    ...
    <el-row>
      ...
      <el-col :span="8">
        <el-form-item label="联系地址">
          <el-input v-model="student.oneAddress"  placeholder="请输入联系地址"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
      ...
      <el-col :span="8">
        <el-form-item label="工作单位">
          <el-input v-model="student.oneWorkunit"  placeholder="请输入工作单位"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label="职务">
          <el-input v-model="student.oneJob"  placeholder="请输入职务"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="8">
        <el-form-item label="联系电话">
          <el-input v-model="student.oneMobile"   placeholder="请输入联系电话"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label="手机号">
          <el-input v-model="student.oneTel"   placeholder="请输入手机号"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label="电子信箱">
          <el-input v-model="student.oneEmail"   placeholder="请输入电子信箱"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
    ...
    <el-row>
      <el-col :span="8">
        <el-form-item label="姓名">
          <el-input v-model="student.twoName"   placeholder="请输入姓名"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label="与孩子关系">
    ...
    <el-row>
      ...
      <el-col :span="8">
        <el-form-item label="联系地址">
          <el-input v-model="student.twoAddress"  placeholder="请输入联系地址"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
      ...
      <el-col :span="8">
        <el-form-item label="工作单位">
          <el-input v-model="student.twoWorkunit"  placeholder="请输入工作单位"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label="职务">
          <el-input v-model="student.twoJob"  placeholder="请输入职务"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="8">
        <el-form-item label="联系电话">
          <el-input v-model="student.twoMobile"   placeholder="请输入联系电话"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label="手机号">
          <el-input v-model="student.twoTel"   placeholder="请输入手机号"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label="电子信箱">
          <el-input v-model="student.twoEmail"   placeholder="请输入电子信箱"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
    ...
    <el-row>
      <el-col :span="8">
        <el-form-item label="户籍管理">
          <el-input v-model="student.domicleControl"   placeholder="请输入户籍管理"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label="出生地">
          <el-input v-model="student.birthPlace"   placeholder="请输入出生地"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label="籍贯">
          <el-input v-model="student.nativePlace"   placeholder="请输入籍贯"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
      ...
      <el-col :span="8">
        <el-form-item label="残疾儿童">
          <el-radio-group v-model="student.isDisabled">
            <el-radio   v-for="item in same" :label="item.value">{{item.label}}</el-radio>
          </el-radio-group>
        </el-form-item>
      </el-col>
      <el-col :span="8">
    ...
    <el-row>
      <el-col :span="8">
        <el-form-item label="其他联系人">
          <el-input v-model="student.otherPeople"   placeholder="请输入其他联系人"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label="其他人电话">
          <el-input v-model="student.otherMobile"   placeholder="请输入其他人电话"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
    ...
    <el-row>
      <el-col :span="8">
        <el-form-item label="备注">
          <el-input v-model="student.remark"   placeholder="请输入备注"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
  </el-form>
  ...
  export default {
    ...
    data() {
      ...
      return {
        leaveFlag:true,//离校状态
        rules:{
          childNo:[{ required: true, validator: this.validateChildNo, trigger: 'blur' }],
          classId:[{required: true, validator: this.validateClassId, trigger: "change"}],
        ...
        nationality :[
          ...
          { value: 42, en: "Democratic Republic of the Congo", label: "刚果（金）" },
          ...
          { value: 73, en: "Falkland Islands", label: "马尔维纳斯群岛（福克兰）" },
          { value: 74, en: "Federated States of Micronesia", label: "密克罗尼西亚联邦" },
          { value: 75, en: "Faroe Islands", label: "法罗群岛" },
          { value: 76, en: "France", label: "法国 法国" },
          { value: 77, en: "Gabon", label: "加蓬" },
          { value: 78, en: "Great Britain (United Kingdom; England)", label: "英国" },
          ...
          { value: 91, en: "South Georgia and the South Sandwich Islands", label: "南乔治亚岛和南桑威奇群岛" },
          ...
          { value: 96, en: "Heard Island and McDonald Islands", label: "赫德岛和麦克唐纳群岛" },
          ...
          { value: 106, en: "British Indian Ocean Territory", label: "英属印度洋领地" },
          ...
          { value: 179, en: "Saint-Pierre and Miquelon", label: "圣皮埃尔和密克隆" },
          ...
          { value: 200, en: "Svalbard and Jan Mayen", label: "斯瓦尔巴群岛和扬马延岛" },
          ...
          { value: 213, en: "Turks & Caicos Islands", label: "特克斯和凯科斯群岛" },
          { value: 214, en: "Chad", label: "乍得" },
          { value: 215, en: "French Southern Territories", label: "法属南部领地" },
      ...
      computeAge(){
        if(!this.student.birthDate||this.student.birthDate==""){
          ...
          if (typeof this.student.birthDate == "string"){
            ...
            var date = new Date(s);
            this.$set(this.student, "age", ((new Date().getTime() - date.getTime()) / 31536000000).toFixed(2));
          }else{
            this.$set(this.student, "age", ((new Date().getTime() - this.student.birthDate.getTime()) / 31536000000).toFixed(2));
          }
        }
      },
      getClassById(classId){
        ...
        getById(classId).then(res => {
          ...
          if (!this.$route.query.id) {
            this.$set(this.student, "educationalCircles", res.data.data.startYear);
          }
        })
